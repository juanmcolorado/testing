...
2. If you want to allow users to self register via User Portal what is the step you need to follow?
...
     b) WSO2 Identity Server supports REST APIs for self user registration.
...
a) It is used to authenticate a user with locally available credentb) It is used to identify and process incoming protocol-specific authentication requests and build protocol-specific responses and send to service providers.
